// icon:calendar-dates | CSS Icons https://css.gg/ | Astrit
import * as React from "react";

function IconCalendarDates(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" height="1.6em" width="1.6em" {...props}>
      <path
        fill="currentColor"
